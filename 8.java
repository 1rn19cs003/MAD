...
public class MainActivityextends AppCompatActivityimplements 
        View.OnClickListener{Button btnOne,btnTwo,btnThree,btnFour,btnFive;
        Button 
        btnSix,btnSeven,btnEight,btnNine,btnZero;
        Button
        btnDel,btnStar,btnHash,btnCall,btnSave;
        EditTexttxtPhonenu
        mber;@Override
        ...
        btnStar=(Button)findViewById(R.id.btn_st
        art);btnStar.setOnClickListener(this);
        ...
        ete);btnDel.setOnClickListener(this);
...
public void onClick(View v)
{
        ...
        (ContactsContract.Intents.Insert.ACT
        ION);contactIntent.setType
        ...
        {
        String 
        data=txtPhonenumber.getText().toString();
        if(data.length()>0)
        {
        txtPhonenumber.setText
...
btnCall.setOnClickListener(new View.OnClickListener()
{
    ...
    public void onClick(View v) {
        String data = 
        txtPhonenumber.getText().toString();Intent 
